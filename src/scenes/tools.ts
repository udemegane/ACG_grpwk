...
export type ScriptMap = {
  [index: string]: {
    ...
    default: new (...args: any[]) =>
      | NodeScriptConstructor
      | GraphScriptConstructor;
  };
};
 ...
 */
function requireScriptForNodes(
  scene: Scene,
 ...
 */
export function attachScriptToNodeAtRuntime(
  scriptPath: string,
  object: Node | Scene
): any {
  const {scriptsMap} = require("./scripts-map");
 ...
 */
export let screenSpaceReflectionPostProcessRef: Nullable<ScreenSpaceReflectionPostProcess> =
  null;
/**
 * Defines the reference to the default rendering pipeline.
 */
export let defaultRenderingPipelineRef: Nullable<DefaultRenderingPipeline> =
  null;
/**
 ...
 */
export function configurePostProcesses(
  scene: Scene,
  rootUrl: string = null
): void {
