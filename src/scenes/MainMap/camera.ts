...
export default class PlayerCamera extends FreeCamera {
  ...
  @visibleInInspector('KeyMap', 'Upwards Key', ' '.charCodeAt(0))
  private _upwardsKey: number;
  ...
  public onStart(): void {
    ...
    this.keysUpward = [this._upwardsKey];
    console.log('camera on start');
    console.log(this.keysUp, this.keysDown, this.keysRight, this.keysLeft, this.keysUpward, this.keysDownward);
  }
